...
export const FloatingButton = () => {
  ...
  const pdfButtons = [
    { label: 'RIS PDF', onClick: () => console.log('RIS PDF clicked') },
    { label: 'ICS PDF', onClick: () => console.log('ICS PDF clicked') },
    { label: 'PR PDF', onClick: () => console.log('PR PDF clicked') },
  ]
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        {isOpen && (
          ...
          >
            {pdfButtons.map((button, index) => (
              <motion.div key={button.label} variants={buttonVariants} custom={index}>
                <Button
      ...
      >
        <Button
          ...
          aria-haspopup="true"
        >
          <span className="sr-only">Quick Generate PDF</span>
          <motion.div

      ...
      return (
        <div className="flex space-x-2 items-center">
          <span
            ...
            onClick={() => navigate(`/bac/abstract-of-quotation/${pr_no}`)}
          >
            {row.getValue("pr_no")}
          </span>
          <Badge className="m-2 p-2 w-6 h-6 flex items-center justify-center border-2  text-slate-950">
            {!rfqCount ? "0" : rfqCount}
          </Badge>
        </div>
      );

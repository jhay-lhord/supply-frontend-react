        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.content}>
            <Text style={{ lineHeight: 0 }}>
              ...
              <Text style={styles.boldText}>{awardDetails.officeSupply}</Text>{" "}
              request, in connection with the{" "}
              <Text style={styles.boldText}>{awardDetails.date}</Text>, is
              hereby awarded{" "}
              <Text style={styles.boldText}>{recipient.name}</Text> being the
              sole bidder with the Lowest Calculated & Responsive Bid at a
              contract price equivalent to{" "}
              <Text style={styles.boldText}>
                {digitsToWords(awardDetails.amount).toUpperCase()} (PHP
                {awardDetails.amount}.00)
              </Text>
              .
            </Text>
          </View>
